...
const handleImageLoad = (event) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-5 min-h-screen bg-gray-100">
      ...
      <div className="flex justify-around w-4/5 flex-grow p-4"> {/* Changed h-full to flex-grow here */}
        <div className="w-1/2 relative overflow-hidden flex items-center justify-center bg-white border-4 border-black rounded">
          ...
          <div className="w-full h-full bg-black bg-opacity-50 flex items-center justify-center">
            ...
            <canvas ref={imageCanvasRef} className="absolute top-0 left-0 w-full h-full overflow-hidden items-center justify-center"/>
          </div>
          <canvas 
            ref={cropCanvasRef} 
          ...
          />
          {croppedImage &&
            <div className="absolute top-2 right-2 w-32 h-32 overflow-hidden bg-white border-4 border-black rounded flex items-center justify-center">
